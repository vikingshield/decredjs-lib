    ...
    try {
      ...
      if (exec && Buffer.isBuffer(opcode)) {
        ...
        switch (opcode) {
          ...
          case Opcode.map.OP_SSTX: break;
          case Opcode.map.OP_SSGEN: break;
          case Opcode.map.OP_SSRTX: break;
          case Opcode.map.OP_CHECKSIGALT: break;
          case Opcode.map.OP_CHECKSIGALTVERIFY: break;
