...
Script.TX_SSTX = TX_SSTX;
Script.TX_SSRTX = TX_SSRTX;
Script.TX_SSGEN = TX_SSGEN;
Script.TX_SSCHANGE = TX_SSCHANGE;
...
Script.prototype.isStakePkScr = function() {
  return (this.chunks[0] == Opcode.map.OP_SSTX ||
      this.chunks[0] == Opcode.map.OP_SSGEN ||
      this.chunks[0] == Opcode.map.OP_SSRTX ||
      this.chunks[0] == Opcode.map.OP_SSTXCHANGE);
};

Script.prototype.isP2SH = function() {
  if (this.isStakePkScr()) {
    return (this.chunks.length == 4 &&
      this.chunks[1] == Opcode.map.OP_HASH160 &&
      Buffer.isBuffer(this.chunks[2]) &&
      this.chunks[2].length == 20 &&
      this.chunks[3] == Opcode.map.OP_EQUAL);
  }
...
Script.prototype.isPubkeyHash = function() {
  if (this.isStakePkScr()) {
    return (this.chunks.length == 6 &&
      this.chunks[1] == Opcode.map.OP_DUP &&
      this.chunks[2] == Opcode.map.OP_HASH160 &&
      Buffer.isBuffer(this.chunks[3]) &&
      this.chunks[3].length == 20 &&
      this.chunks[4] == Opcode.map.OP_EQUALVERIFY &&
      this.chunks[5] == Opcode.map.OP_CHECKSIG);
  }
